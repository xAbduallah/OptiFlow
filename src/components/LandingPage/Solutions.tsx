...
export const Solutions: React.FC = () => {
  const getTransText = useTranslations("LandingPage.Solutions");
        ...
        >
          {SOLUTIONS_DATA.slice(4, 8).map((solution, index) => (
            <motion.article
              ...
              id={solution.Key}
              variants={scaleInVariants}
              className="flex flex-col gap-3 shadow-[0_12px_16px_0_rgba(51,51,51,0.08)] p-2 rounded-2xl scroll-mt-26"
            >
