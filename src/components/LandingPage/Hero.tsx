...
const Hero: React.FC = () => {
  const getTransText = useTranslations("LandingPage.Hero");
  ...
  return (
    <section className=" flex flex-col-reverse relative overflow-hidden ltr:pl-6 rtl:pr-6">
      ...
      {/* Main Section */}
      <div className="main-section flex flex-col lg:flex-row justify-between gap-6 relative">
        {/* Content Section */}
        <motion.div
          initial="hidden"
          animate="visible"
