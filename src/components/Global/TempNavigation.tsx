      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-1/2 -translate-y-1/2 right-5 w-auto bg-white/95 backdrop-blur-md shadow-2xl z-50 rounded-3xl overflow-hidden border border-gray-200"
          >
            {/* Close button */}
            <div className="flex justify-center p-4 border-b border-gray-100">
              ...
              >
                <X
                  onClick={closeSidebar}
                  className="w-12 h-12 text-gray-600 hover:text-red-600 transition-colors duration-200"
                />
              </motion.div>
            </div>
            ...
            <div className="py-4 px-3 flex flex-col gap-3">
              ...
              <Link href="/frappe/erp-next" onClick={closeSidebar}>
                <motion.div
                  custom={2}
                  initial="hidden"
                  animate="visible"
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="group relative flex flex-col items-center justify-center gap-2 p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 hover:from-yellow-100 hover:to-yellow-200 rounded-2xl cursor-pointer transition-all duration-300 border border-yellow-200/50"
                >
                  <div className="p-2.5 bg-white rounded-xl shadow-sm group-hover:shadow-md transition-shadow duration-300">
                    <LaptopMinimalCheck className="w-6 h-6 text-yellow-600 group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <span className="text-xs font-semibold text-gray-700 text-center leading-tight">
                    Frappe
                  </span>
              ...
              <Link href="/not-found" onClick={closeSidebar}>
                <motion.div
                  custom={2}
                  initial="hidden"
                  animate="visible"
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="group relative flex flex-col items-center justify-center gap-2 p-4 bg-gradient-to-br from-red-50 to-red-100 hover:from-red-100 hover:to-red-200 rounded-2xl cursor-pointer transition-all duration-300 border border-red-200/50"
                >
                  <div className="p-2.5 bg-white rounded-xl shadow-sm group-hover:shadow-md transition-shadow duration-300">
                    <X className="w-6 h-6 text-red-500 group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <span className="text-xs font-semibold text-gray-700 text-center leading-tight">
                    Not Found
                  </span>
